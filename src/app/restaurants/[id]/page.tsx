  ...
  if (!restaurant) {
    return (
      <div className="text-center py-20">
        <h1 className="font-headline text-4xl mb-4">Restaurant Not Found</h1>
    ...
    <div className="space-y-10">
      <div className="relative h-64 md:h-96 w-full rounded-xl overflow-hidden shadow-lg">
        ...
        <div className="absolute bottom-0 left-0 p-6 md:p-10">
          <h1 className="font-headline text-4xl md:text-6xl font-bold text-white mb-2">{restaurant.name}</h1>
          <div className="flex items-center space-x-4">
            <Badge variant="secondary" className="text-base bg-opacity-80 backdrop-blur-sm">{restaurant.cuisine}</Badge>
      ...
      <div>
        <h2 className="font-headline text-3xl md:text-4xl font-semibold mb-8 text-center">Menu</h2>
